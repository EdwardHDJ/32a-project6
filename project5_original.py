...
class ColumnsGame:
    ...
    def _draw_matched_jewel(self,jewel:'Jewel'):
        ...
        pygame.draw.rect(self._surface,pygame.Color(0,0,0),jewel_rect)
    ...
    def _time_tick(self):
        ...
        elif game_model.check_if_faller_is_freezed(self._game_faller) == False and self._game_faller != None:
